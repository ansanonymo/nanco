...
export default function ProjectCouter() {
  ...
  return (
    <div className="relative container mx-auto -translate-y-1/3 lg:-translate-y-2/4 z-40">
      ...
      >
        <div className="grid gap-2 sm:gap-3 sm:gap-x-16 md:gap-y-6 md:gap-x-24 lg:gap-20 py-4 sm:py-7 md:py-12  grid-cols-2 md:grid-cols-2 lg:grid-cols-4 w-fit mx-auto">
...
function Counter({ Icon: PropsIcon, count, name }) {
  ...
  return (
    <div className="flex gap-2 sm:gap-2 md:gap-3 items-center">
      {/** icon */}
      <div className="text-3xl sm:text-2xl md:text-5xl lg:text-6xl">
        {<Icon />}
      </div>
      {/** count and text */}
      <div>
        <h2 className="text-base sm:text-lg  md:text-3xl lg:text-4xl font-bold">
          {count}+
        </h2>
