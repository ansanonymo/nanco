...
import DetailsBox from './HomeAbout/DetailsBox'
import Form from './HomeAbout/Forn'

export default function Contact() {
    return (
        <div className=' mx-auto relative max-w-7xl' >
            <div className='bg-center bg-cover z-0 pb-32 pt-12 relative ' style={{ backgroundImage: `url(${bg})` }}>
                <div className=" absolute top-0 left-0 w-full h-full bg-white -z-40 opacity-80">
            ...
            <div className="container -translate-y-32 gap-8 grid lg:grid-cols-[30%,70%] md:grid-cols-[30%,70%] grid-cols-1 justify-center place-items-center">
                <DetailsBox />
                <Form/>
            </div>
        </div>
